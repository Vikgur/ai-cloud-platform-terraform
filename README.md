...
Этот репозиторий — эталонная архитектура Terraform для enterprise-уровня.  
Он показывает, как с нуля спроектировать cloud-platform под Kubernetes (3 master / 50+ worker) с упором на безопасность, масштабируемость и управляемость.

Здесь реализованы принципы best practice:
